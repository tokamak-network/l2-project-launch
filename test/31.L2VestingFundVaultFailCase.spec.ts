...
describe('L2TokenFactory', () => {
    ...
    describe("# PublicSale Test", () => {
        ...
        describe("# depositWithdraw", () => {
            // it("depositWithdraw execute", async () => {
            ...
            it("depositWithdraw fail because erc20Token don't have pool", async () => {
                await expect(
                    deployed.l2PublicProxyLogic.connect(l2ProjectManager).depositWithdraw(erc20Atoken.address)
                ).to.be.reverted
            })
        })
    })
